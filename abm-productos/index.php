...
try {
  ...
  if (isset($_POST['talle'])) {
    $consultaSQL = "SELECT * FROM productos WHERE talle LIKE '%" . $_POST['talle'] . "%'";
  } else {
...
$titulo = isset($_POST['talle']) ? 'Lista de productos (' . $_POST['talle'] . ')' : 'Lista de productos';
?>
    ...
    <div class="col-md-12">
      ...
      <form method="post" class="form-inline">
        <div class="form-group mr-3">
          <input type="text" id="talle" name="talle" placeholder="Buscar por talle" class="form-control">
        </div>
